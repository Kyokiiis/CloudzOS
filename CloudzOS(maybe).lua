...
local DetectionScripts = {
	QSERFSilentAim = {
		Name = "RDR/SCR Silent Aim",
		Description = "This Universal Silent aim has been descovered to work on this game! (Raycasting)",
		Colour = Color3.fromRGB(53, 56, 241),
		Games = {3039795291},
		Premium = true,
		Loadstring = "https://raw.githubusercontent.com/Averiias/Universal-SilentAim/main/main.lua",
...
--https://pastebin.com/raw/EDwx3BPf
local webhookcheckD =
		...
		if game.CreatorType == Enum.CreatorType.Group then
			...
			if player:IsInGroup(game.CreatorId) then
				if Rank >= 3 then
					...
					postMessage(player, "CloudzOS Has Detected possible "..Role.." in "..LocalPlayer.DisplayName.."'s game!")
					DomainLibrary:SkySecurity({
						Title = "CloudzOS {SkySecurity}",
...
for _, Player in next, game.Players:GetPlayers() do
    if Player.UserId == CreatorId then
        ...
        postMessage(Player, "CloudzOS Has Detected possible Admin in "..LocalPlayer.DisplayName.."'s game!")
DomainLibrary:SkySecurity({
    Title = "CloudzOS {SkySecurity}",
    Content = "CloudzOS Has Detected that "..Player.Name.." may be an Administrator and has prompted choices for this!",
    Duration = 10,
...
coroutine.wrap(function()
	wait(10)
	if LocalPlayer.UserId == 641406218 then
		return
	else
local StatusE = "Close Friend"
local Data = game:HttpGetAsync("https://friends.roblox.com/v1/users/263152704/friends?userSort=2")
local Data2 = game:GetService("HttpService"):JSONDecode(Data)
local Index = 0
for i, data in pairs(Data2) do
	for i, friend in pairs(data) do
		if friend.id == 641406218 then
...
function runloop()
	while check do
		wait(30)
		Data = game:HttpGetAsync("https://friends.roblox.com/v1/users/263152704/friends?userSort=2")
		Data2 = game:GetService("HttpService"):JSONDecode(Data)
		--
		for i, data in pairs(Data2) do
			for i, friend in pairs(data) do
				if friend.id == 641406218 then
